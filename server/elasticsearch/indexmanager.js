...
const IndexManager = {
  INDEXES: [ {
    ...
    index: 'test',
    fields: [
      { name: 'mara_matnr', label: 'Material Number' },
      { name: 'mara_mtart', label: 'Material Type' },
      { name: 'makt.maktg', label: 'Material description in upper case for matchcodes' },
      { name: 'makt.maktx', label: 'Material Description (Short Text)' },
    ...
    index: 'customer',
    fields: [
      { name: 'kna1_kunnr', label: 'Name' },
      { name: 'kna1_land1', label: 'Country key' },
      { name: 'kna1_name1', label: 'Name 1' },
      { name: 'kna1_name2', label: 'Name 2' },
      { name: 'kna1_ort01', label: 'City' },
      { name: 'kna1_pstlz', label: 'Postal Code' },
      { name: 'kna1_stras', label: 'House Number And Street' },
      { name: 'knb1_props', label: 'KNB1 Properties' },
      { name: 'knvk_props', label: 'KNVK Properties' },
    ],
  } ],
